...
// Join card to the others colection
AddCondition(20,cf_trigger, "Join card to the others colection", "Game Events", "Join card to the others colection", "Join card to the others colection", "JoinCardsToOtherCollection");

// DeclareRummy
AddCondition(21,cf_trigger, "DeclareRummy", "Game Events", "Declare Rummy", "Declare Rummy", "DeclareRummy");

// Declare Winner - FinalRound
AddCondition(22,cf_trigger, "FinalRound", "Game Events", "Final Round", "Final Round", "FinalRound");

// Declare Winner - HideScoringBoard
AddCondition(23,cf_trigger, "HideScoringBoard", "Game Events", "HideScoringBoard ", "HideScoringBoard", "HideScoringBoard");
...
// Join my card  to other show
AddStringParam("Card List", "A JoinCardList string to send to the server.");
AddNumberParam("Postion", "Send card value to room");
AddAction(9, af_none, "Join my cards to other collection", "Game Events", "Join my cards to other collection", "Join my cards to other collection.", "JoinCardToOtherCollection");

//AcceptScoringBoard
AddAction(10, af_none, "Accept Scoring Board", "Game Events", "Accept Scoring Board", "Accept Scoring Board.", "AcceptScoringBoard");
...
AddNumberParam('Type of Info: 0 for position', "get ShowCardPlayerStatus Info")
AddExpression(15, ef_return_number, "Get ShowCardPlayerStatus Info ", "Game Expression", "GetShowCardPlayerStatus", "Return Player Show Card Status Info");

//GetJoinCardCollectionsInfo
AddNumberParam('Type of Info: 0 for source position, 2 for destination postion, 3 for JoinCardValue ', "get GetJoinCardCollections Info")
AddExpression(16, ef_return_any, "Get GetJoinCardCollections Info  ", "Game Expression", "GetJoinCardCollectionsInfo", "Return Player Join Cards Collection Info");

AddExpression(17, ef_return_string, "Get Rummy Declare Message", "Game Expression", "GetRummyDeclareMsg", "Return GetRummyDeclareMsg");

AddNumberParam('postion:', "position")
AddNumberParam('type of info:', "type of info")
AddExpression(18, ef_return_any, "Get last result Info ", "Game Expression", "GetLastResult", "Return last Info");
